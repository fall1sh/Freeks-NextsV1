  ...
  return (
    ...
    >
      ...
      <motion.h4
        ...
        animate={{ opacity: 1, y: 0 }}
      >
        <span className="font-bold">An Informatics undergraduate at the University of Muhammadiyah Malang</span> currently in the 6th semester 
        <span className="font-bold">
          , data analysis, engineering, and modeling
        </span>
        , using <span className="font-bold">Python, SQL, and Power BI</span> for
        processing datasets, optimizing pipelines, and generating actionable
        insights.
