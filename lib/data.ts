...
export const experiencesData = [
  {
    ...
    location: "Malang",
    description:
      "Universitas Muhammadiyah Malang (UMM) merupakan perguruan tinggi swasta yang didirikan tahun 1964 dan berada di bawah naungan Persyarikatan Muhammadiyah. Saat ini, UMM memiliki 62 program studi dalam beberapa jenjang pendidikan.",
  ...
  },
  {
    ...
    location: "Ponorogo",
    description:
      "Ponorogo Jawa Timur adalah tempat bagi salah satu pondok pesantren terbesar dan terbaik di Indonesia yaitu Pondok Pesantren Modern Gontor. Pada tanggal 20 September 1926, tiga bersaudara putra Kiai Santoso Anom Besari membuka sekolah swasta Islam ini.",
    icon: React.createElement(CgWorkAlt),
    date: "Mar 2018 - Mar 2022",
  },
  {
    title: "MTs Islamiyah Ujungpangkah",
    location: "Gresik",
    description:
      "Madrasah Tsanawiyah Islamiyah adalah sebuah lembaga pendidikan setingkat SMP yang berada dibawah naungan Yayasan Taman Pendidikan Islamiyah. Yang berkecimpung dalam dunia pendidikan dan sosial. MTs Islamiyah didirikan pada tahun 1984. Dibentuk dalam rangka mewujudkan pendidikan alternatif setingkat SMP dan menampung lulusan angkatan pertama dari lembaga pendidikan setingkat MI/SD (Sedrajat) yang juga berada dibawah naungan Yayasan Taman Pendidikan Islamiyah ataupun lainnya.",
    icon: React.createElement(CgWorkAlt),
    date: "Feb 2014 - Feb 2017",
  },
  {
    title: "MIS Islamiyah Ujungpangkah",
    location: "Gresik",
    description:
      "MIS Islamiyah, dengan NPSN 60719229, berdiri kokoh di Jl. Setro Barat No. 09, Desa/Kelurahan Pangkah Kulon, Kecamatan Ujung Pangkah, Kabupaten Gresik, Jawa Timur. Sebagai sekolah swasta di bawah naungan Kementerian Agama, MIS Islamiyah telah diakui kualitasnya dengan meraih akreditasi A berdasarkan SK No. 164/BAP-S/M/SK/XI/2017 tertanggal 17 November 2017.",
    icon: React.createElement(CgWorkAlt),
    date: "Jul 2007 - Sep 2013",
  },
] as const;
